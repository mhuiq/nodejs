...
const SELECTFORINDEX = "SELECT T1.APPID, T2.HOUSEINFO, T1.APPINFO, T1.REGISTERTIME, T1.MOBILEPHONE FROM authdb.TAB_DEV_INFO T1, authdb.TAB_HOUSE_INFO T2 WHERE T1.HOUSEID = T2.HOUSEID AND T1.RECORDSTATUS = 'Y'";
